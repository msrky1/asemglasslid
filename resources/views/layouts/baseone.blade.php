        ...
        <div class="row">
          ...
          <nav class="header-nav-wrap">
            <ul class="header-nav">
              ...
              <li>
                <select onchange="if (this.value) window.location.href=this.value" style="color: white; backgorund-color:black;">
                  <option value="/tr" @if (App::getLocale()) @endif @if (App::isLocale('tr')) selected @endif style="color: red; background-color:black" selected>Türkçe</option>
                  <option value="/en" @if (App::getLocale()) @endif @if (App::isLocale('en')) selected @endif style="color: red; background-color:black" value="1">İngilizce</option>
