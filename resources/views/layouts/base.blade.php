    ...
    <header class="s-header">
        <div class="row">
            <div class="header-logo">
                <a class="site-logo" href="/"><img src="{{ asset('assets') }}/logo.png" alt="Homepage" /></a>
            </div>
            <nav class="header-nav-wrap">
                <ul class="header-nav">
                    ...
                    <li>
                        <a class="smoothscroll" href="#services" title="services">{{ __('home.neleryapıyoruz') }}</a>
                    </li>
                    <li>
                        <a class="smoothscroll" href="#works" title="works">{{ __('home.ürünler') }}</a>
                    </li>

                    <li>
                        <a class="smoothscroll" href="#contact" title="contact">{{ __('home.iletişim') }}</a>
                    </li>
                    <li>
