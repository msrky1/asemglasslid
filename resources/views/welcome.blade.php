        ...
        <div class="portfolio block-1-4 block-m-1-3 block-tab-1-2 collapse">
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                <div class="item-folio__thumb">
                    <a href="{{ asset('assets') }}/images/product/ctype1.jpg" class="thumb-link"
                        title="{{ __('home.projeler1') }}" data-size="1050x700">
                        <img src="{{ asset('assets') }}/images/product/ctype1.jpg"
                            srcset="
          ...
          "
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                <div class="item-folio__thumb">
                    <a href="{{ asset('assets') }}/images/product/ctype12.jpg" class="thumb-link"
                        title="  {{ __('home.projeler2') }}" data-size="1050x700">
                        <img src="{{ asset('assets') }}/images/product/ctype12.jpg"
                            srcset="
          ...
          "
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                <div class="item-folio__thumb">
                    <a href="{{ asset('assets') }}/images/product/gtype.jpg" class="thumb-link"
                        title="{{ __('home.projeler') }}" data-size="1050x700">
                        <img src="{{ asset('assets') }}/images/product/gtype.jpg"
                            srcset="
        ...
        <section id="contact" class="s-contact target-section">
            <div class="row section-header" data-aos="fade-up">
                <div class="col-full">
                    ...
                    <h1 class="display-1 display-1--light">
                        {{ __('home.bizeulaşın2') }}
                        <a href="/cdn-cgi/l/email-protection#d0f3e0"><span class="__cf_email__"
                                data-cfemail="2c44494040436c5f584940404d5e024f4341">info@trglasslid.com</span></a>
                    </h1>
                </div>
            </div>
            <div class="row contact-infos">
                ...
                <div class="col-four md-six tab-full contact-number" data-aos="fade-up">
                    ...
                    <ul class="contact-list">
                        <li>
                            <a href="mailto: info@trglasslid.com"><span class="__cf_email__"
                                    data-cfemail="4d24232b220d3e392821212c3f632e2220">Email Gönder</span></a>
                        </li>
                        <li><a href="tel:197-543-2345">0344 221 12 12 </a></li>
                        <p>{{ __('home.adres') }} </p>
            ...
            <div class="row contact-bottom">
                ...
                <div class="col-six tab-full contact-subscribe" data-aos="fade-up">
                    ...
                    <form enctype="multipart/form-data" method="POST" class="group mc-form"
                        action="/{{ app()->getLocale() }}/send">
                        @csrf
                        <input type="email" name="body" class="email" id="mc-email" placeholder="Email"
                            required />
